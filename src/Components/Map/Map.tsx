...
export const Map = () => {
  ...
  const checkId = (idToCheck: string) => {
    ...
    if (foundState) {
      setStateName(foundState.attributes.name.toLocaleLowerCase());
      return foundState.attributes.zipCodes;
    } else {
      return "";
    }
  };

  const handleHover = (event: React.MouseEvent<SVGPathElement>) => {
      ...
      >
        ...
        >
          <g id="g5">
            <a
              target="_blank"
              href={`https://codigo-postal.co/en-us/usa/${stateName}`}
            >
              <path
                id="HI"
                data-info={`<div>State: Hawaii</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a> </div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="AK"
                data-info={`<div>State: Alaska</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="FL"
                data-info={`<div>State: Florida</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="SC"
                data-info={`<div>State: South Carolina</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="GA"
                data-info={`<div>State: Georgia</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="AL"
                data-info={`<div>State: Alabama</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="NC"
                data-info={`<div>State: North Carolina</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="TN"
                data-info={`<div>State: Tennessee</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="RI"
                data-info={`<div>State: Rhode Island</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="CT"
                data-info={`<div>State: Connecticut</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="MA"
                data-info={`<div>State: Massachusetts</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="ME"
                data-info={`<div>State: Maine</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="NH"
                data-info={`<div>State: New Hampshire</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="VT"
                data-info={`<div>State: Vermont</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="NY"
                data-info={`<div>State: New York</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="NJ"
                data-info={`<div>State: New Jersey</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="PA"
                data-info={`<div>State: Pennsylvania</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="DE"
                data-info={`<div>State: Delaware</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="MD"
                data-info={`<div>State: Maryland</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="WV"
                data-info={`<div>State: West Virginia</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="KY"
                data-info={`<div>State: Kentucky</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="OH"
                data-info={`<div>State: Ohio</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="MI"
                data-info={`<div>State: Michigan</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            <path
              id="WY"
              data-info={`<div>State: Wyoming</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
              fill="#D3D3D3"
            ...
            >
              <path
                id="MT"
                data-info={`<div>State: Montana</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="ID"
                data-info={`<div>State: Idaho</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="WA"
                data-info={`<div>State: Washington</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="TX"
                data-info={`<div>State: Texas</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="CA"
                data-info={`<div>State: California</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="AZ"
                data-info={`<div>State: Arizona</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="NV"
                data-info={`<div>State: Nevada</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="UT"
                data-info={`<div>State: Utah</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="CO"
                data-info={`<div>State: Colorado</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="NM"
                data-info={`<div>State: New Mexico</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="OR"
                data-info={`<div>State: Oregon</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="ND"
                data-info={`<div>State: North Dakota</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="SD"
                data-info={`<div>State: South Dakota</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="NE"
                data-info={`<div>State: Nebraska</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="IA"
                data-info={`<div>State: Iowa</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="MS"
                data-info={`<div>State: Mississippi</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="IN"
                data-info={`<div>State: Indiana</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="IL"
                data-info={`<div>State: Illinois</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="MN"
                data-info={`<div>State: Minnesota</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="WI"
                data-info={`<div>State: Wisconsin</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="MO"
                data-info={`<div>State: Missouri</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="AR"
                data-info={`<div>State: Arkansas</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="OK"
                data-info={`<div>State: Oklahoma</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="KS"
                data-info={`<div>State: Kansas</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="LA"
                data-info={`<div>State: Louisiana</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            >
              <path
                id="VA"
                data-info={`<div>State: Virginia</div><div>Zip code: <a target=_blank href=${`https://codigo-postal.co/en-us/usa/${stateName}`}>${foundItem}</a></div>`}
                fill="#D3D3D3"
            ...
            <g id="DC">
              ...
              <a target="_blank" href={`https://codigo-postal.co/en-us/usa/`}>
                <circle
                  id="circle60"
                  data-info={`<div>Washington DC </div><div>Zip code: 20001 - 88888 </div>`}
                  fill="#D3D3D3"
                  stroke="#FFFFFF"
                  strokeWidth="1.5"
                  cx="975.3"
